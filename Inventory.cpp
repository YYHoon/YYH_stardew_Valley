...
void Inventory::update()
{
	...
	if (!_isInventoryOpen)
	{
		_quickSlotSelectRc = RectMake(_selecRcX, _selecRcY, _quickSlotSelect->getWidth(), _quickSlotSelect->getHeight());
		quickSlotMove();
	}
...
void Inventory::render()
{
	...
	if (!_isInventoryOpen)
	{
		...
		_testImage->render(getMemDC(), _indexRC[0].left, _indexRC[0].top);
		_testImage2->render(getMemDC(), _indexRC[1].left, _indexRC[1].top);
		_quickSlotSelect->render(getMemDC(), _quickSlotSelectRcX, _quickSlotSelectRcY);
	}
	Rectangle(getMemDC(), _quickSlotSelectRc);
	/////////////////////////////////////////////////////////////////////////// <Debug_Rect>
